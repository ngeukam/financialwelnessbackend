...
class Users(AbstractUser):
    ...
    role=models.CharField(max_length=50,blank=True,null=True,default='Customer',choices=(('Admin','Admin'),('Customer','Customer'),('Staff','Staff')))
